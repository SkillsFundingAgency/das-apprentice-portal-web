...
{
    public class ApprenticeIdFromRegistrationIdTests
    {
        [Test, MoqAutoData]
        public void Missing_both_claims_is_ignored(AuthenticationEvents sut, ClaimsPrincipal identity, Guid id)
        {
            ...
            identity.Claims.Should()
                .NotContain(c => c.Type.Equals("registration_id", StringComparison.OrdinalIgnoreCase));
            identity.Claims.Should()
                .NotContain(c => c.Type.Equals("apprentice_id", StringComparison.OrdinalIgnoreCase));
        }

        [Test, MoqAutoData]
        public void Registration_claim_is_converted_to_apprentic_claim(AuthenticationEvents sut,
            ClaimsPrincipal identity, Guid id)
        {
        ...
        [Test, MoqAutoData]
        public void Registration_claim_does_not_overwrite_existing_apprentice_claim(AuthenticationEvents sut,
            ClaimsPrincipal identity, Guid registrationId, Guid apprenticeId)
        {
